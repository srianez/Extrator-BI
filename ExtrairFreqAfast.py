...
class ExtrairFreqAfast:
    try:       
        def extrair_freq_afast(self, banco_oriem, diretorio_arquivo_parquet, tab_freqAfast, tenant_id):
            ...
            print("#### Inicio do processamento do ETL CARREGA_FREQ_AFAST.", datetime.datetime.now())
            ...
            print("#### Inicio da geração do arquivo "+ tab_freqAfast +".parquet | Inicio do processamento: ", datetime.datetime.now() )
            ...
            print("    #### Término da geração do arquivo "+ tab_freqAfast +".parquet | Inicio do processamento: ", datetime.datetime.now() )
